...
class ReportGenerator:
    ...
    def generate_markdown(self, analyzed_papers):
        ...
        for p in analyzed_papers:
            ...
            md_content += f"- **相关度评分:** `{p['analysis'].get('relevance_score', 'N/A')}/10`\n"
            ...
            md_content += f"- **质量评价:** {p['analysis'].get('quality_evaluation', '无')}\n"
            md_content += f"- **推荐理由:** {p['analysis'].get('recommendation_reason', '无')}\n"
